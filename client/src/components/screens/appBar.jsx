...
export default function Navbar() {
  ...
  const { navbarShow, setNavbarShow, userName, setUserName, profileImage, setProfileImage } = React.useContext(authContext);
  const logout = () => {
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ backgroundColor: "#06283D", }}>
        <Toolbar>
          ...
          <Link to="/showFiles" style={{ textDecoration: "none" }}>
            <Button
              variant="contained"
              component="label"
              color="secondary"
          ...
          <Typography
            ...
            noWrap
            component="div"
            sx={{ display: { xs: 'none', sm: 'block', me: 4 } }}
            className='mx-4'
          >
            {userName}
          </Typography>
